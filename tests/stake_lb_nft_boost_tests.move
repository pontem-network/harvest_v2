...
module harvest::stake_lb_nft_boost_tests {
    ...
    public fun test_boost_and_remove_boost() {
        ...
        mint_token(&st_collection_owner, token_data_id, 1500000000);
        token::direct_transfer(&st_collection_owner, &alice_acc, token_id, 1500000000);
    ...
    public fun test_reward_calculation_with_boost() {
        ...
        let token_id = token::get_token_id(&stake_token);
        let token_data_id = token::get_tokendata_id(token_id);
        mint_token(&st_collection_owner, token_data_id, 300000000);
        token::direct_transfer(&st_collection_owner, &alice_acc, token_id, 150000000);
        token::direct_transfer(&st_collection_owner, &bob_acc, token_id, 150000000);
        ...
        let token = stake_lb::unstake<RewardCoin>(&alice_acc, @harvest, st_collection_name, 50000000);
        ...
        let split_token = token::withdraw_token(&alice_acc, token_id, 150000000);
        stake_lb::stake<RewardCoin>(&alice_acc, @harvest, split_token);
    ...
    public fun test_boosted_amount_calculation() {
        ...
        let token_id = token::get_token_id(&stake_token);
        let token_data_id = token::get_tokendata_id(token_id);
        mint_token(&st_collection_owner, token_data_id, 3000000000);
        token::direct_transfer(&st_collection_owner, &alice_acc, token_id, 1500000000);
        token::direct_transfer(&st_collection_owner, &bob_acc, token_id, 1500000000);
        ...
        let split_token = token::withdraw_token(&alice_acc, token_id, 10000000);
        stake_lb::stake<RewardCoin>(&alice_acc, @harvest, split_token);
        ...
        let split_token = token::withdraw_token(&bob_acc, token_id, 800000000);
        stake_lb::stake<RewardCoin>(&bob_acc, @harvest, split_token);
        ...
        // check values
        let total_boosted = stake_lb::get_pool_total_boosted<RewardCoin>(@harvest, st_collection_name);
        let user_boosted = stake_lb::get_user_boosted<RewardCoin>(@harvest, st_collection_name, @bob);
        ...
        let token =
            stake_lb::unstake<RewardCoin>(&alice_acc, @harvest, st_collection_name, 255000000);
        token::deposit_token(&alice_acc, token);
    ...
    public fun test_is_boostable() {
        ...
        let duration = 15768000;
        stake_lb::register_pool<StakeCoin>(&harvest, &stake_token, reward_coins, duration, option::none());

        // check is boostable
        assert!(stake_lb::is_boostable<RewardCoin>(@harvest, st_collection_name), 1);
        assert!(!stake_lb::is_boostable<StakeCoin>(@harvest, st_collection_name), 1);
    ...
    public fun test_is_boosted() {
        ...
        let token_id = token::get_token_id(&stake_token);
        let token_data_id = token::get_tokendata_id(token_id);
        mint_token(&st_collection_owner, token_data_id, 500000000);
        token::direct_transfer(&st_collection_owner, &alice_acc, token_id, 500000000);
        ...
        assert!(!stake_lb::is_boosted<RewardCoin>(@harvest, st_collection_name, @alice), 1);
    ...
    public fun test_boost_fails_if_pool_does_not_exist() {
        let (harvest, _, _) = initialize_test();
        ...
        stake_lb::boost<RewardCoin>(&harvest, @harvest, st_collection_name, nft);
    }
    ...
    public fun test_remove_boost_fails_if_pool_does_not_exist() {
        ...
        let nft = stake_lb::remove_boost<RewardCoin>(&harvest, @harvest, st_collection_name);
    ...
    public fun test_is_boostable_fails_if_pool_does_not_exist() {
        ...
        stake_lb::is_boostable<RewardCoin>(@harvest, st_collection_name);
    }
    ...
    public fun test_get_boost_config_fails_if_pool_does_not_exist() {
        let st_collection_name = string::utf8(b"Liquidswap v1 #1 \"CX\"-\"CY\"-\"X25\"");
        stake_lb::get_boost_config<RewardCoin>(@harvest, st_collection_name);
    }
    ...
    public fun test_get_pool_total_boosted_fails_if_pool_does_not_exist() {
        let st_collection_name = string::utf8(b"Liquidswap v1 #1 \"CX\"-\"CY\"-\"X25\"");
        stake_lb::get_pool_total_boosted<RewardCoin>(@harvest, st_collection_name);
    }
    ...
    public fun test_is_boosted_fails_if_pool_does_not_exist() {
        let st_collection_name = string::utf8(b"Liquidswap v1 #1 \"CX\"-\"CY\"-\"X25\"");
        stake_lb::is_boosted<RewardCoin>(@harvest, st_collection_name, @alice);
    }
    ...
    public fun test_get_user_boosted_fails_if_pool_does_not_exist() {
        let st_collection_name = string::utf8(b"Liquidswap v1 #1 \"CX\"-\"CY\"-\"X25\"");
        stake_lb::get_user_boosted<RewardCoin>(@harvest, st_collection_name, @alice);
    }
    ...
    public fun test_boost_fails_if_already_boosted() {
        ...
        stake_lb::boost<RewardCoin>(&alice_acc, @harvest, st_collection_name, nft_1);
        stake_lb::boost<RewardCoin>(&alice_acc, @harvest, st_collection_name, nft_2);
    ...
    public fun test_boost_fails_if_amount_more_than_one() {
        ...
        let token_id = token::get_token_id(&stake_token);
        let token_data_id = token::get_tokendata_id(token_id);
        mint_token(&st_collection_owner, token_data_id, 1000);
        token::direct_transfer(&st_collection_owner, &bob_acc, token_id, 1000);

        // stake 1000 StakeCoins from bob
        // let coins =
        //     coin::withdraw<StakeCoin>(&bob_acc, 1000);
        let split_token = token::withdraw_token(&bob_acc, token_id, 1000);
        stake_lb::stake<RewardCoin>(&bob_acc, @harvest, split_token);

        stake_lb::boost<RewardCoin>(&bob_acc, @harvest, st_collection_name, nft);
    ...
    public fun test_stake_and_boost_two_accounts_in_time() {
        ...
        let split_token = token::withdraw_token(&bob_acc, token_id, 500000000);
        stake_lb::stake<RewardCoin>(&bob_acc, @harvest, split_token);
        ...
        let nft = stake_lb::remove_boost<RewardCoin>(&bob_acc, @harvest, st_collection_name);
    ...
    public fun test_stake_and_boost_two_accounts_and_unstake() {
        ...
        let stake_token = stake_lb::unstake<RewardCoin>(&bob_acc, @harvest, st_collection_name, 500000000);
        token::deposit_token(&bob_acc, stake_token);
