...
module harvest::stake_lb_nft_boost_tests {
    ...
    public fun test_boosted_amount_calculation() {
        ...
        // stake 500 StakeCoins from alice
        let split_token = mint_stake_token(&st_collection_owner, token_data_id_1, 500000000);
        stake_lb::stake<RewardCoin>(&alice_acc, @harvest, split_token);
        ...
        let split_token = mint_stake_token(&st_collection_owner, token_data_id_1, 10000000);
        stake_lb::stake<RewardCoin>(&alice_acc, @harvest, split_token);
        ...
        let split_token = mint_stake_token(&st_collection_owner, token_data_id_1, 800000000);
        stake_lb::stake<RewardCoin>(&bob_acc, @harvest, split_token);
        ...
        let token =
            stake_lb::unstake<RewardCoin>(&alice_acc, @harvest, st_collection_name, bin_id_1, 255000000);
        token::deposit_token(&alice_acc, token);
    ...
    public fun test_boost_fails_if_amount_more_than_one() {
        ...
        let split_token = mint_stake_token(&st_collection_owner, token_data_id_1, 1000);
        stake_lb::stake<RewardCoin>(&bob_acc, @harvest, split_token);
    ...
    public fun test_stake_and_boost_two_accounts_and_additional_stake() {
        ...
        let split_token = mint_stake_token(&st_collection_owner, token_data_id_2, 500000000);
        stake_lb::stake<RewardCoin>(&bob_acc, @harvest, split_token);
    ...
    public fun test_stake_and_boost_two_accounts_and_unstake() {
        ...
        let token = stake_lb::unstake<RewardCoin>(&bob_acc, @harvest, st_collection_name, bin_id_2, 500000000);
    ...
    public fun test_stake_and_boost_two_accounts_and_unstake_harvest_fails() {
        ...
        let stake_token = stake_lb::unstake<RewardCoin>(&bob_acc, @harvest, st_collection_name, bin_id_2, 500000000);
